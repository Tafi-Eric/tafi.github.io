  ...
  updates: [
    {
      ...
      body:  { ca: "Durant el meu dia a dia no acostumo a pensar cap a on vaig, quin objectiu final té allò que estic fent. Ve predefinit per una decisió que es va prendre fa X temps i que, un cop marcada, l'ideal és no replantejar-la i actuar de manera automàtica. L'última decisió que vaig prendre va ser quina carrera estudiar. Un cop vaig entrar a Economia, en una universitat que no cal esmentar, he estat 4 anys on el meu objectiu final era acabar el grau. Pel camí hi ha hagut subobjectius: intentar passar-ho bé, aconseguir una universitat per anar d'Erasmus, fer pràctiques d'empresa. Però l'objectiu seguia sent el mateix: que, passats 4 anys, tingués els 240 crèdits que acrediten que he assolit una formació, que tinc cert coneixement tècnic i una capacitat per tirar les coses endavant. Oficialment ja m'he graduat d'Economia, però tinc la sensació de "i ara què m'espera?". Quina és la decisió correcta, el següent step? Tinc bastantes opcions però no sé què fer. A les pràctiques m'han fet oferta, però paguen molt poc i tinc por d'acabar en una posició que no m'agrada, estancat. Trobar una alternativa tampoc és una tasca gaire senzilla: tota la part de banca d'inversió és molt competitiva i no és fàcil entrar-hi. I la part de marxar fora, que abans tenia molt clara, ara la torno a posar sobre la taula. És el moment per fer-ho, perquè els lligams amb un lloc concret són els més dèbils que tindré mai: no tinc persones que depenguin de mi, no tinc cap feina que em faci de limitant, no tinc cap propietat. A més, aquests primers anys poden ser els més crítics a nivell inicial. Per una banda em sap greu deixar el que he estat fent a l'empresa de pràctiques i deixar enrere l'equip de persones. Però és que no em compensa, i estic pensant de deixar-ho i fer-me un últim estiu tranquil, de vacances. I ara què? Suposo que aquesta vegada la decisió toca prendre-la despert, no en automàtic. He de definir quin és el següent objectiu i traçar un roadmap per arribar-hi.",
               en: "In my day-to-day life, I don't usually think about where I'm going or what the ultimate goal is of what I'm doing. It's predefined by a decision that was made a while ago, and once it's been made, the ideal is not to rethink it and to act automatically. The last decision I made was which major to study. Once I got into Economics at a university that needs no mention, I spent 4 years with the ultimate goal of finishing my degree. Along the way, there were smaller goals: trying to have a good time, getting into a university for an Erasmus exchange, and doing an internship. But the goal remained the same: that after 4 years, I would have the 240 credits that certify I have completed an education, that I have certain technical knowledge and the ability to get things done. I've officially graduated with a degree in Economics, but I have this feeling of “what's next?”. What's the right decision, the next step? I have quite a few options but I don't know what to do. I got an offer from my internship, but they pay very little and I'm afraid of ending up in a position I don't like, stuck in a rut. Finding an alternative isn't an easy task either: the investment banking sector is very competitive, and it's not easy to get into. And the option of moving abroad, which I was so sure about before, is now back on the table. This is the time to do it, because my ties to any one place are the weakest they'll ever be: I don't have anyone depending on me, I don't have a job that's holding me back, I don't own any property. Besides, these first few years can be the most critical for getting started. On one hand, I feel bad about leaving what I've been doing at my internship and the team behind. But it's just not worth it to me, and I'm thinking of quitting and having one last quiet summer, just relaxing. So what now? I guess this time I have to make the decision consciously, not on autopilot. I need to define my next objective and map out a roadmap to get there.
    },
    {
      date: "2025 · 11",
